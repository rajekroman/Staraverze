...
| Expertiza `expertiseScreen` | samostatný povinný krok | dokončení Besednice → výběr až 5 konkrétních kamenů → perk | neběží | fokus na nadpis, Tab mezi kartami a „PŘEVZÍT CERTIFIKÁTY“, Enter/mezerník; Escape krok neobejde; výběr přežije reload | klepnutí na karty a potvrzení |
